...
/**
 * Enqueue scripts and styles. - CHANGE THE PREFIX FROM red_starter to inhabitent
 */
function inhabitent_scripts() {
	...
	wp_enqueue_style(  'inhabitent-font-awesome', "https://use.fontawesome.com/releases/v5.2.0/css/all.css");

	//add font awesome - add CDN then add enqueue scripts
